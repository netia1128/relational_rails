...
ActiveRecord::Schema.define(version: 2021_05_11_004543) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "b1_permit", force: :cascade do |t|
    ...
    t.index ["b3_facilities_id"], name: "index_b1_permit_on_b3_facilities_id"
  end
  ...
  add_foreign_key "b1_permit", "b3_facilities", column: "b3_facilities_id"
end
